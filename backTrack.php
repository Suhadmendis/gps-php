...
<section class="content">
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Vehicle BackTrack</h3>
        </div>
        <form role="form" class="form-horizontal">
            <div class="form-groups-sm">
                <label class="col-sm-2 labelColour input-sm" > City List</label>
            ...
            <a onclick="load1();" class="btn btn-default">
